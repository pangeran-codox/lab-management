...
<head>
    ...
    <style>
        ...
        .sidebar-nav::-webkit-scrollbar-thumb { background:rgba(185,217,235,.18); border-radius:4px; }
        .sidebar-nav::-webkit-scrollbar-thumb:hover { background:rgba(185,217,235,.35); }
        /* Firefox */
        .sidebar-nav { scrollbar-width:thin; scrollbar-color:rgba(185,217,235,.2) transparent; }
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <nav class="sidebar-nav flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            $navItems = [
                ...
                ['route'=>'journal.index',          'label'=>'Jurnal Lab',         'icon'=>'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                ...
                ['route'=>'file-manager.index',      'label'=>'Kelola File',         'icon'=>'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z', 'roles' => ['admin', 'super_admin']],
                ['route'=>'settings.index',         'label'=>'Pengaturan',         'icon'=>'M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z', 'roles' => ['admin', 'super_admin']],
                ['route'=>'mikrotik.settings.index', 'label'=>'MikroTik',           'icon'=>'M5 12h14M5 12a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v4a2 2 0 01-2 2M5 12a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2v-4a2 2 0 00-2-2m-2-4h.01M17 16h.01', 'roles' => ['admin', 'super_admin']],
            ];
            @endphp
